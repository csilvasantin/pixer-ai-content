(function () {
  const STORAGE_KEY = 'pixer-brief-v.2026.05.02-r12';
  const KEYS_STORE = 'pixer-keys';
  const VERSION = 'v.2026.05.02-r12';
  ...
  const MOTORES = {
    ...
    video: [
      { id: 'pixer-storyboard', nombre: 'Pixer Storyboard',     tipo: 'free', coste: 'gratis · navegador',     desc: '3 escenas + crossfade + voz en off' },
  ...
  function playVideo() {
    ...
    showPlayer(`
      <div class="player-card">
        ...
        <div class="sb-stage" style="aspect-ratio:${w}/${h};">
          ${scenes.map((sc, i) => `
