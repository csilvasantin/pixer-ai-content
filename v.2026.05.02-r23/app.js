(function () {
  const STORAGE_KEY = 'pixer-brief-v.2026.05.02-r23';
  const KEYS_STORE = 'pixer-keys';
  const VERSION = 'v.2026.05.02-r23';
  ...
  const MOTORES = {
    ...
    musica: [
      ...
      { id: 'suno-local',     nombre: 'Suno (local)',           tipo: 'pro',  coste: 'tu plan Suno',                  desc: 'requiere suno-local en :3777' },
      { id: 'suno-local-v45', nombre: 'Suno v4.5 (local)',      tipo: 'pro',  coste: 'tu plan Suno',                  desc: 'mejor estructura · hasta 8min' },
    ],
    imagenes: [
