...
// Pentatónica Cm · ${totalBeats} beats · ${(beat * totalBeats).toFixed(1)}s</pre>
  ...
  //   - localhost (suno-local :3777)  → audio mp3 + video mp4 + YouTube/Vimeo/Twitter/etc
  //   - HTTPS publico (admira-tube via Tailscale Funnel) → solo YouTube + video mp4
  // El navegador bloquea fetch http://localhost desde paginas https://, asi que
  // si la pagina vive en GitHub Pages routeamos a la Funnel publica que ya tiene
  // yt-dlp expuesto detras de un certificado real.
